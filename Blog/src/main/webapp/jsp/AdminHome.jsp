    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="apost">
                    <h2 class="instruct">Administrator Instructions:</h2>
                    <div class="line"></div>
                    <h3 class="instruct para">~ Welcome to the administration page of your content management system. ~</h3>
                    <div class="line"></div>
                    <h3 class="para">On the left-hand side you will find a list of options available for managing content and permissions, please click those links to proceed to those functional areas.</h3>
                    <div class="line"></div>
                </div>
            </div>
        </div>
