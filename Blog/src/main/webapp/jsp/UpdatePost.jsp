     ...
     <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="blogCenter">Update Blog Post</h2>                  
                        <div class="spacingDiv"></div>
                        <div class="line"></div>
                        <div class="spacingDiv"></div>
                    </div>
                    <sf:form id="createPostForm" class="form-horizontal" commandName="pcm" action="${pageContext.request.contextPath}/UpdatePost" method="POST">
                        <input type="hidden" name="postId" value="${spvm.post.postId}">
                        <div class="form-group">
                            <label class="col-xs-3 control-label">User Id</label>
                            <div class="col-xs-5">
                                <sf:errors path="name" cssclass="error"></sf:errors>
                                    <input type="text" name="userId" id="userId" class="form-control" rows="5" path="userId" value="${spvm.post.user.userId}">        
                            </div>
                        </div>   
                        <div class="form-group">
                            <label class="col-xs-3 control-label">Post Title</label>
                            <div class="col-xs-5">
                                <sf:errors path="postTitle" cssclass="error"></sf:errors>
                                    <input type="text" name="postTitle" id="postTitle" class="form-control" rows="5" path="postTitle" value="${spvm.post.postTitle}">        
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-3 control-label">Post Content</label>
                            <div class="col-xs-5">
                                <sf:errors path="postContent" cssclass="error"></sf:errors>
                                    <input type="textarea" name="postContent" id="postContent" class="form-control" rows="5" path="postContent" value="${spvm.post.postContent}">        
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-3 control-label">Category Id</label>
                            <div class="col-xs-5">
                                <sf:errors path="categoryId" cssclass="error"></sf:errors>
                                    <input type="text" name="categoryId" id="categoryId" class="form-control" rows="5" path="categoryId" value="${spvm.post.category.categoryId}">        
                            </div>
                        </div>
                    
                    <div class="form-group">
                        <div class="col-xs-5 col-xs-offset-3">
                            <button type="submit" class="btn btn-default" id="btnCreatePost">Update Post</button>
                            <button type="button" class="btn btn-default" id="btnCancel"><a href="${pageContext.request.contextPath}/AdminManagePosts/displayPostAdminPage">Cancel</a></button>
                        </div>
