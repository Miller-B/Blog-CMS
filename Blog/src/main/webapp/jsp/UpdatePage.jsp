   ...
   <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="blogCenter">Update Page</h2>  
                    <div class="spacingDiv"></div>
                    <div class="line"></div>
                    </div>
                    <sf:form id="createPageForm" class="form-horizontal" commandName="spcm" action="${pageContext.request.contextPath}/AdminManagePages/UpdatePage" method="POST">
                        <input type="hidden" name="staticPageId" value="${spvm.selectedStaticPage.staticPageId}">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">Page Title:</label>
                        <div class="col-xs-5">
                        <sf:errors path="pageTitle" cssclass="error"></sf:errors>
                            <input type="text" name="staticPageTitle" id="pageTitle" class="form-control" rows="5" path="staticPageTitle" value="${spvm.selectedStaticPage.staticPageTitle}"></input>         
                        </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-3 control-label">Page Content:</label>
                            <div class="col-xs-5">
                                <sf:errors path="pageContent" cssclass="error"></sf:errors>
                                    <input type="textarea" name="staticPageContent" id="pageContent" class="form-control" rows="5"
                                           path="staticPageContent" value="${spvm.selectedStaticPage.staticPageContent}"></input>         
                            </div>
                        </div>
                   
                    <div class="form-group">
                        <div class="col-xs-5 col-xs-offset-3">
                            <button type="submit" class="btn btn-default" id="btnCreatePage">Update Page</button>
                            <button type="button" class="btn btn-default" id="btnCancel"><a href="${pageContext.request.contextPath}/AdminManagePages/displayPageAdminPage">Cancel</a></button>
                        </div>
                    </div>
                </sf:form>
                </div>
