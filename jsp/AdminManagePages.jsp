...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/managePages.css">
    </head> 
      ...
      <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">  
                    ...
                    <div class="line"></div> 
                    <c:forEach var="currentSpvm" items="${spvm}" varStatus="loop">
                    <div class="page">
                        <h3 class="blogCenter">${currentSpvm.staticPageTitle}</h3>
                        <br>
                        <p>${currentSpvm.staticPageContent}</p>
                    </div>
                    <div>
                        <a href="${pageContext.request.contextPath}/AdminManagePages/displayUpdatePage?staticPageId=${currentSpvm.staticPageId}">Edit</a><text> | </text> 
                        <a href="${pageContext.request.contextPath}/AdminManagePages/displayDeletePage?staticPageId=${currentSpvm.staticPageId}">Delete</a>
                    </div>
                    <div class="spacingDiv"></div>
                    <div class="line"></div> 
                    </c:forEach>
        ...
        <script src="${pageContext.request.contextPath}/js/staticPages.js" type="text/javascript"></script> 
    </body>
</html>
