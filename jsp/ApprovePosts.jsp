        ...
        <div class="wrapper">
            ...
            <div id="content">
                <div class="container-fluid" id="topbar">
                    ...
                    <h2 class="adminApproveCenter">Awaiting Approval:</h2>
                    <div class="spacingDiv"></div>
                    <div class="line"></div>  
                    <c:forEach items="${avm.spvms}" var="currentApvm" varStatus="loop">
                        <c:if test="${!currentApvm.post.approval}">
                        <div class="apost">
                            <h2>${currentApvm.post.postTitle}</h2>
                            ...
                            <br>
                            <br>
                            <a class="btn btn-primary" type="button" href="${pageContext.request.contextPath}/AdminManagePosts/approvePost?postId=${currentApvm.post.postId}">Approved</a>                   
                        </div>
                        <div class="spacingDiv"></div>
                        <div class="line"></div>  
                        </c:if>
