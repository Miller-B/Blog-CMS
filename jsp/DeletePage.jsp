        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <sf:form class="form-horizontal" role="form" modelAttribute="button" action="${pageContext.request.contextPath}/AdminManagePages/DeletePage" method="POST">
                            <button type="button" class="btn btn-default" id="btnCancel"><a href="${pageContext.request.contextPath}/AdminManagePages/displayAdminManagePage">Cancel</a></button>                       
