     ...
     <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="blogCenter">Make a Blog Post</h2>
                    ...
                    <sf:form id="createPostForm" class="form-horizontal" commandName="pcm"
                             action="${pageContext.request.contextPath}/CreatePost" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-5">
                                <sf:errors path="name" cssclass="error"></sf:errors>
                                    <input type="text" name="userId" id="userId" class="form-control" rows="5"
                                           placeholder = "Enter User ID" path="userId"></input>         
                                </div>
                            </div>   
                            ...
                            <div class="form-group">
                                ...
                                <sf:errors path="postTitle" cssclass="error"></sf:errors>
                                    <input type="text" name="postTitle" id="postTitle" class="form-control" rows="5"
                                           placeholder="Enter Title" path="postTitle"></input>         
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <sf:errors path="postContent" cssclass="error"></sf:errors>
                                    <input type="textarea" name="postContent" id="postContent" class="form-control" rows="5"
                                           placeholder="Enter Post Content" path="postContent"></input>         
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <sf:errors path="categoryId" cssclass="error"></sf:errors>
                                    <input type="text" name="categoryId" id="categoryId" class="form-control" rows="5"
                                           placeholder="Enter Category Id" path="categoryId"></input>         
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-5 col-xs-offset-3">
                                <button type="submit" class="btn btn-default" id="btnCreatePost">Post</button>
                                <button type="button" class="btn btn-default" id="btnCancel"><a href="${pageContext.request.contextPath}/">Cancel</a></button>
                        </div>
